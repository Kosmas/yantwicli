class UsersController < ApplicationController
  ...
  def block
    ...
    # TODO: Does it really block the user
    # Need to check again as it doesnt' seem to
    if client.block(params)
      flash[:message] = 'This user has been blocked'
      redirect_to users_blocked_path
    else
      flash[:error] = 'Sorry this user cannot be blocked.'
      render friends_list_path
    end
  end
